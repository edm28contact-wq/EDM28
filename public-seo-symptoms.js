...
<aside class="mobile-drawer" id="mobile-menu" data-mobile-drawer aria-hidden="true">
  ...
  <nav class="drawer-nav" aria-label="Navigation mobile">
    ...
    <a href="/?page=history"><span class="nav-icon"><svg viewBox="0 0 24 24"><path d="M4 6h16v14H4z"/><path d="M7 3h10v3H7zM8 10h8M8 14h8"/></svg></span><span class="nav-label">Mes interventions</span><span class="nav-arrow">›</span></a>
