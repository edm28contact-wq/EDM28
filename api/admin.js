...
export default function handler(req, res) {
  ...
  try {
    ...
    html = html
      ...
      .replace('</body>', `<script src="/admin-intervention-order-publish.js?v=${build}"><\/script><script src="/admin-invoice-auto-pdf.js?v=${build}"><\/script><script src="/admin-published-payments.js?v=${build}"><\/script><script src="/admin-hide-published.js?v=${build}"><\/script></body>`);
