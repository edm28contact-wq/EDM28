...
/* Copilot subframe button container - horizontal layout. */
#copilot-subframe-buttons {
  display: flex;
  flex-direction: row;
  gap: 8px;
  margin-top: 12px;
...
/* Copilot subframe buttons - remove individual margins when in container. */
#copilot-subframe-buttons .copilot-subframe-reload,
#copilot-subframe-buttons .copilot-subframe-diagnose {
  margin-top: 0;
}
...
// Diagnose button click handler for Copilot subframes - runs network
// diagnostics via the native host mojom path.
function subFrameDiagnoseErrorsClick() {
    window.parent.postMessage({
        eventName: 'Edge.WCP.Notify.RunNetworkDiagnostics',
        requestId: String(Date.now()),
    }, '*');
}
...
function getHtml(data, showingDetails) {
    ...
    ${data.footer ? x `
      <div class="footer">
        <div class="left-footer">
          ${data.productLogo ? x `
            <img class="edge-logo"
                 src="data:image/png;base64,${data.productLogo}"
                 alt="">
          ` : ''}
    ...
    ${data.summary ? x `
      <div id="sub-frame-error">
        ...
        ${data.isCopilotProcess && (data.diagnoseButton || data.reloadButton) ? x `
          <div id="copilot-subframe-buttons">
            ${data.diagnoseButton ? x `
              <button id="diagnose-button"
                  class="blue-button text-button copilot-subframe-diagnose"
                  @click="${subFrameDiagnoseErrorsClick}">
  ...
  <div id="content"><!---->
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          <h1>
            <span>Désolé, impossible d’accéder à cette page.</span>
          </h1>
          <!--?lit$385600403$-->
            <p>Il semble que la page Web de <strong jscontent="failedUrl">https://chatgpt.com/backend-api/estuary/content?id=file_00000000503c72468a1c628dd1d0d2de&amp;ts=494852&amp;p=fs&amp;cid=1&amp;sig=d8baf6e625a6d7ed640ba43ea408c57ea76907f4f0ae4eeb44e52d2bca0c9385&amp;v=0</strong> rencontre peut-être des problèmes ou qu’elle ait été déplacée définitivement vers une nouvelle adresse web.</p>
          
          <div id="diagnose-frame" class="hidden"></div>

          <!--?lit$385600403$-->

          <div class="error-code"><!--?lit$385600403$-->ERR_INVALID_RESPONSE</div>
    ...
    <!--?lit$385600403$-->
      <div class="footer">
        <div class="left-footer">
          <!--?lit$385600403$-->
            <img class="edge-logo" alt="" src="data:image/png;base64,">
          
          <div class="edge-branding-text"><!--?lit$385600403$-->Microsoft Edge</div>
        </div>
      </div>
    ...
    <!--?lit$385600403$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">Il semble que la page Web de <strong jscontent="failedUrl">https://chatgpt.com/backend-api/estuary/content?id=file_00000000503c72468a1c628dd1d0d2de&amp;ts=494852&amp;p=fs&amp;cid=1&amp;sig=d8baf6e625a6d7ed640ba43ea408c57ea76907f4f0ae4eeb44e52d2bca0c9385&amp;v=0</strong> rencontre peut-être des problèmes ou qu’elle ait été déplacée définitivement vers une nouvelle adresse web.</div>
        <!--?lit$385600403$-->
      </div>
...
<script>var loadTimeDataRaw = {"details":"Détails","errorCode":"ERR_INVALID_RESPONSE","fontfamily":"system-ui, sans-serif","fontfamilyMd":"system-ui, sans-serif","fontsize":"75%","footer":{"msg":"Microsoft Edge"},"heading":{"msg":"Désolé, impossible d’accéder à cette page."},"hideDetails":"Masquer les détails","iconClass":"icon-elixir-thinking","isOfflineError":false,"is_windows_xbox_sku":"false","language":"fr","productLogo":"","suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"msg":"Il semble que la page Web de \u003Cstrong jscontent=\"failedUrl\">https://chatgpt.com/backend-api/estuary/content?id=file_00000000503c72468a1c628dd1d0d2de&amp;ts=494852&amp;p=fs&amp;cid=1&amp;sig=d8baf6e625a6d7ed640ba43ea408c57ea76907f4f0ae4eeb44e52d2bca0c9385&amp;v=0\u003C/strong> rencontre peut-être des problèmes ou qu’elle ait été déplacée définitivement vers une nouvelle adresse web."},"textdirection":"ltr","title":"chatgpt.com"};</script></body></html>
