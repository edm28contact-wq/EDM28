...
export default function handler(req, res) {
  ...
  try {
    ...
    html = html
      ...
      .replace('content="EDM AUTO - Demande mécanique simple, estimation claire et reprise manuelle."', 'content="EDM28 est un garage situé à Saint-Lubin-de-la-Haye (28410), spécialisé en freinage et liaison au sol, avec devis et suivi transparents."')
