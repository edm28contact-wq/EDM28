...
export default function handler(req, res) {
  ...
  try {
    ...
    html = html
      ...
      .replace('<meta name="theme-color" content="#111827">', '<meta name="theme-color" content="#ffffff">')
