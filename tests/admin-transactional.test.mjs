...
test('sensitive admin workflows use transactional RPC calls without intercepting workshop preparation', async () => {
  ...
  assert.doesNotMatch(source, /button\.dataset\.prepare/);
  assert.doesNotMatch(source, /\[data-prepare\]/);
