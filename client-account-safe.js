        ...
        <div class="grid">
          <div class="card">
            ...
            <div class="summary" style="margin-top:14px">
              <div class="summary-line"><span>Nom</span><strong>${esc(lastName || '-')}</strong></div>
              <div class="summary-line"><span>Prénom</span><strong>${esc(firstName || '-')}</strong></div>
              <div class="summary-line"><span>Téléphone</span><strong>${esc(phone || '-')}</strong></div>
              <div class="summary-line"><span>Email</span><strong>${esc(email || '-')}</strong></div>
            </div>
          </div>
          <div class="card">
            <h3>Actions sur le compte</h3>
            <div class="btn-row" style="margin-top:14px">
              <button class="btn btn-secondary" id="safeAccountSignOut" type="button">Se déconnecter</button>
            </div>
