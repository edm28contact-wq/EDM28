  ...
  function patchHomeAndHelp() {
    ...
    page.innerHTML = `<div class="panel">
      ...
      <div class="edm-flow-grid">
        ...
        <article class="edm-flow-card"><span class="pill blue">4</span><h3 style="margin-top:10px">Pièces puis rendez-vous</h3><p>Après acceptation, EDM28 prépare les pièces. Si un débours est nécessaire, vous validez le mandat et la provision. Le rendez-vous devient disponible lorsque les pièces requises sont reçues.</p></article>
